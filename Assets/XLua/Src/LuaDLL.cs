...
namespace XLua.LuaDLL
{
	...
	public partial class Lua
	{
        ...
        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadProtobuff(System.IntPtr L)
        {
            return luaopen_pb(L);
        }

        public delegate void XLua_Unity_Log_Delegate(UnityEngine.LogType logType, string message);
        ...
        private static void On_XLuaLog_WarpUnity(UnityEngine.LogType logType, string message)
        {
            switch (logType)
            {
